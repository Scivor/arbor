...
class CLIHandler(HedgeHandler):
    ...
    def start(self, message: Optional[str] = None) -> None:
        task = message or "Coffee V3.0 套保扫描"
        print()
    ...
    def on_event(self, event: CoffeeEvent) -> None:
        ...
        # coffee_v3: severity >= 3 为重要事件，总打印；< 3 只在 print_all 时打印
...
class JSONHandler(HedgeHandler):
    ...
    def start(self, message: Optional[str] = None) -> None:
        ...
        meta = {
            ...
            "task": message or "coffee_v3_scan",
        }
...
# ============================================================
# Telegram Handler — Sherlock 无等价 (coffee_v3 创新)
# ============================================================
...
class DebugHandler(HedgeHandler):
    ...
    coffee_v3: 打印完整 event 对象 (含 metadata) 用于调试 regime 检测
    """
