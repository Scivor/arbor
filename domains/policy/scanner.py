...
class PolicyDomainScanner(BaseDomainScanner):
    ...
    def __init__(self, bus: Optional[EventBus] = None, scan_interval: int = 300):
        ...
        from domains.policy.news_monitor import PolicyNewsMonitor
        ...
        self.news_monitor = PolicyNewsMonitor(self.bus)
    ...
    def scan_all(self) -> List[CoffeeEvent]:
        ...
        events.extend(self.news_monitor.check_and_publish())
